...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetStatus = channel.unary_unary(
                ...
                request_serializer=payment__service__pb2.StatusRequest.SerializeToString,
                response_deserializer=payment__service__pb2.StatusResponse.FromString,
                _registered_method=True)
...
def add_PaymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetStatus,
                    request_deserializer=payment__service__pb2.StatusRequest.FromString,
                    response_serializer=payment__service__pb2.StatusResponse.SerializeToString,
            ),
    }
...
class PaymentService(object):
    ...
    def GetStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/payment.PaymentService/GetStatus',
            payment__service__pb2.StatusRequest.SerializeToString,
            payment__service__pb2.StatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
