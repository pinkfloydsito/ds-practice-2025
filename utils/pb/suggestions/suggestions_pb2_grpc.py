...
class BookSuggestionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InitializeOrder = channel.unary_unary(
                '/booksuggest.BookSuggestion/InitializeOrder',
...
def add_BookSuggestionServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'booksuggest.BookSuggestion', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('booksuggest.BookSuggestion', rpc_method_handlers)
