...
class TransactionVerificationServiceServicer(
    ...
    def VerifyTransaction(self, request, context):
        ...
        if cached:
            ...
            print(f"[TransactionVerification] No init data for {order_id}, fallback to request only.")
        ...
        print(f"[TransactionVerification] VerifyTransaction order {order_id} => {is_valid}, reason={reason}")
